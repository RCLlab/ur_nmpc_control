...
#else
  #define CASADI_PREFIX(ID) ur_5_expl_ode_hess_ ## ID
#endif
...
/* ur_5_expl_ode_hess:(i0[6],i1[6x6],i2[6x6],i3[6],i4[6],i5[59])->(o0[12],o1[78]) */
...
CASADI_SYMBOL_EXPORT int ur_5_expl_ode_hess(const casadi_real** arg, casadi_real** res, casadi_int* iw, casadi_real* w, int mem){
  return casadi_f0(arg, res, iw, w, mem);
}

CASADI_SYMBOL_EXPORT int ur_5_expl_ode_hess_alloc_mem(void) {
  return 0;
}

CASADI_SYMBOL_EXPORT int ur_5_expl_ode_hess_init_mem(int mem) {
  return 0;
}

CASADI_SYMBOL_EXPORT void ur_5_expl_ode_hess_free_mem(int mem) {
}

CASADI_SYMBOL_EXPORT int ur_5_expl_ode_hess_checkout(void) {
  return 0;
}

CASADI_SYMBOL_EXPORT void ur_5_expl_ode_hess_release(int mem) {
}

CASADI_SYMBOL_EXPORT void ur_5_expl_ode_hess_incref(void) {
}

CASADI_SYMBOL_EXPORT void ur_5_expl_ode_hess_decref(void) {
}

CASADI_SYMBOL_EXPORT casadi_int ur_5_expl_ode_hess_n_in(void) { return 6;}

CASADI_SYMBOL_EXPORT casadi_int ur_5_expl_ode_hess_n_out(void) { return 2;}

CASADI_SYMBOL_EXPORT casadi_real ur_5_expl_ode_hess_default_in(casadi_int i){
  switch (i) {
    default: return 0;
  }
}

CASADI_SYMBOL_EXPORT const char* ur_5_expl_ode_hess_name_in(casadi_int i){
  switch (i) {
    case 0: return "i0";
    case 1: return "i1";
    case 2: return "i2";
...
CASADI_SYMBOL_EXPORT const char* ur_5_expl_ode_hess_name_out(casadi_int i){
  switch (i) {
    case 0: return "o0";
    case 1: return "o1";
    default: return 0;
...
CASADI_SYMBOL_EXPORT const casadi_int* ur_5_expl_ode_hess_sparsity_in(casadi_int i) {
  switch (i) {
...
CASADI_SYMBOL_EXPORT const casadi_int* ur_5_expl_ode_hess_sparsity_out(casadi_int i) {
  switch (i) {
...
CASADI_SYMBOL_EXPORT int ur_5_expl_ode_hess_work(casadi_int *sz_arg, casadi_int* sz_res, casadi_int *sz_iw, casadi_int *sz_w) {
  if (sz_arg) *sz_arg = 6;
  if (sz_res) *sz_res = 2;
  if (sz_iw) *sz_iw = 0;
  if (sz_w) *sz_w = 0;

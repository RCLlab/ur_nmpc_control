...
/* ur_5_expl_ode_hess:(i0[6],i1[6x6],i2[6x6],i3[6],i4[6],i5[66])->(o0[12],o1[78]) */
...
CASADI_SYMBOL_EXPORT int ur_5_expl_ode_hess(const casadi_real** arg, casadi_real** res, casadi_int* iw, casadi_real* w, void* mem){
